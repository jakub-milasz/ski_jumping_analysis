...
class MyGUI:
    def __init__(self):
        ...
        self.title6 = tk.Label(stats_frame, text="Procent skoków za punkt K", font=("Arial", 12))
        ...
        # jakie statystyki wyświetlić:
        # ulubiona skocznia normalna
        # ulubiona skocznia duza
        # ulubiona skocznia loty
        # średnia ocena za styl
    ...
    def show_stats(self):
      ...
      self.value5.config(text=stats[1])
      self.value6.config(text=stats[2])
